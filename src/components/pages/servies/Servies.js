...
const Servies = () => {
  ...
  return (
    <>
      <Helmet>
            <title>servies</title>
            <meta name='description'content='this servies page for codezen team included all servies that codezen team provied' />
            <link rel='canonical' href='/servies' />
      </Helmet>
    <BreadCrumb title= {t("servies_breadCrumb")}/>
                ...
                return (
                  <div className='col-lg-4 col-md-4 col-12' key={item.id}>
                   ...
                   <img loading='lazy' src={item.iconUrl} alt={item.header} />
                    ...
                    <svg loading='lazy' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f7723e" fillOpacity="1" d="M0,0L40,21.3C80,43,160,85,240,101.3C320,117,400,107,480,133.3C560,160,640,224,720,224C800,224,880,160,960,154.7C1040,149,1120,203,1200,240C1280,277,1360,299,1400,309.3L1440,320L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
                    </div>
                    </div>
                  </div>
                )
